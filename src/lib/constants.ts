...
export const APP_NAME = process.env.NEXT_PUBLIC_FRAME_NAME || "Ansluta";
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_FRAME_DESCRIPTION || "Simple authentication app";
